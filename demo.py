...
model_path = './CRNN_50.pth'
# 需要测试的图片，如./data/demo.png
img_path = './Challenge2_Training_Task3_Images_GT/word_635.png'
# 和类别对应的字母表，如 0123456789abcdefghijklmnopqrstuvwxyz
alphabet = "!&'(),-./0123456789:>?@ABCDEFGHIJKLMNOPRSTUVWXYZ\\abcdefghijklmnopqrstuvwxyz|"
